...
@Component
class ItemActionCallback : AfterSaveCallback<Item>, AfterDeleteCallback<Item> {

    override fun onAfterSave(entity: Item, outboundRow: OutboundRow, table: SqlIdentifier): Publisher<Item> {
        TODO("Not yet implemented")
    }

    override fun onAfterDelete(aggregate: Item): Item {
        TODO("Not yet implemented")
    }
}
